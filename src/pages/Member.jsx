...
export default function Member() {
    return (
        <div className="p-4 font-dmsans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 font-dmsans">
            ...
            <div className="flex justify-end gap-6 font-dmsans">
...
function StatCard({ label, value }) {
    return (
        <div className="bg-[#2B3242] w-44 h-48 rounded-2xl flex flex-col justify-center items-center p-4 shadow-md font-dmsans">
            <MdPeople className="text-[#FF8E29] text-5xl mb-2" />
            <span className="text-[#FF8E29] text-2xl font-bold">{value}</span>
            <span className="text-[#FF8E29] font-medium mt-1 text-xs uppercase tracking-wider">{label}</span>
        </div>
    );
}